...
import { getAllFacultys, removeFaculty } from '../../Services/Allapi';
...
function FacultyHome() {
    ...
    const getFacultys = async () => {
        const response = await getAllFacultys(search)
    ...
    // funcation to delete student
      const deleteFaculty = async (id) => {
        const { data } = await removeFaculty(id)
    ...
    return (
        <div >
            ...
            </div>
            {
                ...
                showSpain ? <TableFaculty facultystoDisplay={allFaculty} delFaculty={deleteFaculty} /> : <SpinningC></SpinningC>
