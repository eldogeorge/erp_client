...
import { editFaculty, getSingleFaulty } from '../../Services/Allapi';
...
function FacultyEdit() {
    ...
    const getFacultyData = async () => {
        let { data } = await getSingleFaulty(params)
        console.log(data);
        setuserData(data)
    ...
    const handleEdit = async (s) => {
        ...
        const { rollNo, fname, lname, email, password, mobile, gender, department, location } = userData
        ...
        if (rollNo == "") {
            ...
            Image ? data.append('faculty_profile', Image) : data.append('faculty_profile', existingImg)
            ...
            // BRS7 api call
            const response = await editFaculty(params, headerConfig, data)
                ...
                <Row>
                    <Col xs={12} sm={12} md={6} lg={6} xl={6} className='p-5'>
                        ...
                        <form style={{ width: '50%', marginLeft: '30%' }} id='box1' className='p-5'>
                            <div class="mb-1">
                                <img
                                    src={Preview ? Preview : `${baseURL}/facultyUploads/${existingImg}`}
