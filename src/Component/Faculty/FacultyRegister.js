...
import { facultyRegisterAPI} from '../../Services/Allapi';
...
function FacultyRegister() {
  ...
  const handleSubmit = async (s) => {
    ...
    if (rollNo == "") {
      ...
      data.append('faculty_profile', Image)
      ...
      // BRS7 api call
      const response = await facultyRegisterAPI(headerConfig, data)
        ...
        <Row>
          <Col xs={12} sm={12} md={6} lg={6} xl={6} className='p-5'>
            <form style={{ width: '50%', marginLeft: '30%' }} id='box1' className='p-5'>
              <div class="mb-1">
                <img
                  src={Preview ? Preview : "https://i.postimg.cc/Mp4NRLKm/profile.jpg"}
